  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-neutral-950/95 backdrop-blur-sm p-4">
    <div className="max-w-md w-full bg-neutral-900 border border-brand-800 rounded-2xl p-8 text-center shadow-2xl shadow-brand-900/20">
      ...
      <div className="flex flex-col gap-3">
        <button 
          onClick={onVerify}
          className="w-full py-4 bg-brand-600 hover:bg-brand-500 text-white font-bold rounded-lg transition-all duration-300 uppercase tracking-wider shadow-lg shadow-brand-900/50"
        >
...
export const NavbarLanding = () => (
  <nav className="fixed top-0 w-full z-40 bg-neutral-950/80 backdrop-blur-md border-b border-brand-900/30">
    <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
      <div className="text-2xl font-serif font-bold text-brand-600 tracking-widest">
        SCARLET
      </div>
      <div className="flex items-center gap-6">
        <NavLink 
          to="/login" 
          className="px-6 py-2 bg-brand-600 hover:bg-brand-500 rounded-full text-xs font-bold uppercase tracking-wide transition-all shadow-[0_0_15px_-3px_rgba(225,29,72,0.6)] text-white"
        >
          Login
        </NavLink>
        <NavLink 
          to="/register" 
          className="text-brand-600 hover:text-brand-400 text-xs font-bold uppercase tracking-wide transition-colors"
        >
          Cadastro
        </NavLink>
      </div>
...
export const Hero = () => (
  <header id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
    ...
    <div className="relative z-10 text-center px-4 max-w-4xl mx-auto mt-10">
      <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-brand-500/30 bg-brand-950/30 text-brand-400 text-xs uppercase tracking-widest mb-6">
        <Star className="w-3 h-3 text-brand-400" /> Top 1% Creator
      </div>
      <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif font-bold text-transparent bg-clip-text bg-gradient-to-b from-white to-brand-400 mb-6 drop-shadow-lg">
      ...
      <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
        ...
        <a href="#benefits" className="w-full md:w-auto px-8 py-4 border border-brand-700 hover:bg-brand-950/50 text-brand-400 font-medium rounded-lg transition-all duration-300 uppercase tracking-wider">
          Saiba Mais
        </a>
      </div>
    </div>

    <div className="absolute bottom-10 left-1/2 -translate-x-1/2 animate-bounce text-brand-600">
    ...
    <section id="gallery" className="py-24 bg-neutral-950 relative">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-serif font-bold text-brand-600 mb-4">Galeria Preview</h2>
          <div className="h-1 w-24 bg-brand-600 mx-auto rounded-full"></div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          ...
          <button className="inline-flex items-center gap-2 text-brand-600 hover:text-brand-400 font-bold uppercase tracking-wide border-b border-brand-800 pb-1 hover:border-brand-600 transition-all">
    ...
    <div className="max-w-6xl mx-auto px-4">
      <div className="grid md:grid-cols-3 gap-12">
        <div className="text-center p-6 rounded-2xl bg-neutral-950/50 border border-neutral-800 hover:border-brand-800 transition-colors duration-300">
          <div className="w-16 h-16 mx-auto bg-brand-900/20 rounded-full flex items-center justify-center mb-6 text-brand-600">
            <Star className="w-8 h-8" />
          </div>
          <h3 className="text-xl font-serif font-bold text-brand-600 mb-3">Conteúdo Diário</h3>
        ...
        <div className="text-center p-6 rounded-2xl bg-neutral-950/50 border border-neutral-800 hover:border-brand-800 transition-colors duration-300">
          ...
          <h3 className="text-xl font-serif font-bold text-brand-600 mb-3">Pedidos Personalizados</h3>
          <p className="text-neutral-400 leading-relaxed">
        ...
        <div className="text-center p-6 rounded-2xl bg-neutral-950/50 border border-neutral-800 hover:border-brand-800 transition-colors duration-300">
          ...
          <h3 className="text-xl font-serif font-bold text-brand-600 mb-3">Chat Privado</h3>
          <p className="text-neutral-400 leading-relaxed">
